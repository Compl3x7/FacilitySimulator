...
public class Robot
{
     ...
     */
    public Robot(Point chargingPoint, Map map, UnweightedHashGraph<Point> mapGraph)
    {
        this.pathFinder = new PathFinder(map, mapGraph);
        this.chargingPoint = chargingPoint;
        this.currentPosition = chargingPoint;
        this.currentBatteryLevel = MAX_BATTERY;
        this.minimumBatteryLevel = (mapGraph.size() + 2) * MOVE_ENERGY_COST;
